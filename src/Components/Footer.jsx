    ...
    return (
        <footer className="footer mt-10 bottom-0 footer-center p-10 bg-base-200 text-base-content rounded">
            <div className="border-b-2 pb-10">
                <div>
                    <h1 className=" text-2xl md:text-4xl font-black ">Monazila</h1>
                ...
                <nav>
                    <div className="grid grid-flow-col gap-4 mt-4">
                        <a href="https://www.google.com/"><FaGoogle className="text-2xl " /></a>
                        <a href="https://github.com/"><FaGithub className="text-2xl" /></a>
